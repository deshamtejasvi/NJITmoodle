		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<div style="align: right; position: fixed;">
				...
				<div class="row carousel-holder">
					...
					<div class="col-md-12">
						<div id="carousel-example-generic" background=""
							...
							<form
								style="background: url('Images/tableback.jpg'); width: 670px; height: 170px;"
								id="course" action="registration.jsp" method="post">
								</br>
								<div style="color: #FF0000;">Enter any one option to search</div>
								Enter Course: <select name="Terms">
									<option value="0" selected></option>
									<option value="computer">computer</option>
									<option value="electrical">electrical</option>
								</select> </br> </br> Enter the course number  <input type="text" id="coursenumber"
									name="coursenumber" />  Enter the section number  <input
									type="text" id="sectionnumber" name="sectionnumber" /> </br> </br>
